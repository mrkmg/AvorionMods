...
meta =
{
    ...
    title = "Fleet Jump Order (CraftOrdersLib compatible)",

    -- Description of your mod that will be displayed to players
    description = "Rewrite of MassCraxx's Fleet Jump through Gate Command to work with CraftOrdersLib",

    -- Insert all authors into this list
    authors = {"Kevin Gravier (MrKMG)", "MassCraxx"},
