...
meta =
{
    ...
    name = "OrderChainNavigation",

    -- Title of your mod that will be displayed to players
    title = "Order Chain Navigation",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a goto next and goto previous order for skipping forwards or backwards through an order chain.",
    ...
    -- },
    dependencies = {
        {id = "1837703287", min = "1.9"},
        {id = "Avorion", max = "1.0.2"}
    },
