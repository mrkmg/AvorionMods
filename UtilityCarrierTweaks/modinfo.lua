...
meta =
{
    ...
    name = "UtilityCarrierTweaks",

    -- Title of your mod that will be displayed to players
    title = "Utility Carrier Tweaks",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Tweaks the AI of Mining and Salvaging Carriers. Carriers will collect all their fighters before they fly to their next target if that target is more than 5km away.",
